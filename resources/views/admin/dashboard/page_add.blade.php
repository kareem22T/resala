                ...
                <div class="w-100 p-3">
                    <div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div contenteditable="true" id="page-content" class="form-control" style="min-height: 300px"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-3 w-100">
                ...
                <div class="w-25">
                    ...
                    <div class="w-100 mb-3 pb-5">
                        <button type="submit" class="btn btn-primary w-50 form-control" style="height: fit-content" @click="this.getContentpage().then(() => {this.add()})"><i class="ti ti-plus"></i> Add</button>
                    </div>
                </div>
            </div>
        </div>
  ...
  methods: {
    ...
    async add() {
      $('.loader').fadeIn().css('display', 'flex')
        try {
            const response = await axios.post(`{{ route('pages.put') }}`, {
                title: this.title,

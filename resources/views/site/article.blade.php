...
@section('styles')
    <style>
        ...
        article .content strong:first-of-type {
            display: none
        }
    </style>
@endsection
...
@if ($article)
    @section('content')
        <main>
            <article>
                <h1
                    style="display: flex;justify-content: space-between;flex-direction: column;gap: 16px;padding-bottom: 16px !important">
                    {{ $article->title }}
                    @if($article->type == 'post')
                    <div class="thumbnail">
                        <img style="  width: 300px;height: auto;object-fit: cover;" src="{{ $article->thumbnail_path }}"
                            alt="{{ $article->title }}">
                    </div>
                    @endif
                </h1>
            ...
            <aside>
                <div class="facebook-card">
                    ...
                    <div class="fb-page fb_iframe_widget" data-href="https://www.facebook.com/Resala.org"
                        data-small-header="1" data-adapt-container-width="true" data-hide-cover="" data-hide-cta="false"
                        data-show-facepile="1" data-show-posts="" fb-xfbml-state="rendered"
                        fb-iframe-plugin-query="adapt_container_width=true&amp;app_id=376512092550885&amp;container_width=287&amp;hide_cover=false&amp;hide_cta=false&amp;href=https%3A%2F%2Fwww.facebook.com%2FResala.org&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;show_posts=false&amp;small_header=true">
                        <span style="vertical-align: bottom; width: 287px; height: 70px;"><iframe name="f3a4574b8b32ad6"
                                data-testid="fb:page Facebook Social Plugin" title="fb:page Facebook Social Plugin"
                                allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media"
                                style="border: medium none; visibility: visible; width: 287px; height: 70px;"
                                src="https://www.facebook.com/v2.5/plugins/page.php?adapt_container_width=true&amp;app_id=376512092550885&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df60d9007ed600a%26domain%3Dresala.org%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fresala.org%252Ff723e7ee241cbc%26relation%3Dparent.parent&amp;container_width=287&amp;hide_cover=false&amp;hide_cta=false&amp;href=https%3A%2F%2Fwww.facebook.com%2FResala.org&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;show_posts=false&amp;small_header=true"
    ...
    <script>
        document.querySelectorAll('.content').forEach(contentElement => {
            contentElement.innerHTML = contentElement.innerHTML.replace(
                /\[embed\](https?:\/\/[^\s\[\]]+)\[\/embed\]/g,
                (match, url) => {
                    return `<iframe width="560" height="315" src="${url.replace('youtu.be/', 'www.youtube.com/embed/')}"
